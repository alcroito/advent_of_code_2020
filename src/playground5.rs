...
type DynParser3<'a, 'b> = dyn FnMut(InputType<'a>) -> nom::IResult<InputType<'a>, InputType<'a>> + 'b;
...
// but meh.
type NomParserWrapperExact5<'a, 'b> = NomParserWrapper<Box<dyn FnMut(&'a str) -> nom::IResult<&'a str, &'a str> + 'b>>;
